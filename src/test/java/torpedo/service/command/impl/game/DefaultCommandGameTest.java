...
/**
 * Unit tests for {@link DefaultCommandGame}.
 */
@ExtendWith(MockitoExtension.class)
public class DefaultCommandGameTest {
    ...
    private DefaultCommandGame underTest;

    @BeforeEach
    public void setUp() {
        underTest = new DefaultCommandGame(printWrapper);
    }
