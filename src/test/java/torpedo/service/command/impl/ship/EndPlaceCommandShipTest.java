...
/**
 * Unit tests for {@link EndPlaceCommandShip}.
 */
@ExtendWith(MockitoExtension.class)
public class EndPlaceCommandShipTest {

    private static final String END_PLACE_COMMAND = "end place";
    private static final String NOT_END_PLACE_COMMAND = "";
    ...
    private EndPlaceCommandShip underTest;
    ...
    public void setUp() {
        ...
        underTest = new EndPlaceCommandShip(gameState, printWrapper);
    }
    ...
    public void testCanProcessShouldReturnTrueWhenInputIsExit() {
        ...
        // when
        boolean result = underTest.canProcess(END_PLACE_COMMAND);
    ...
    public void testCanProcessShouldReturnFalseWhenInputIsNotExit() {
        ...
        // when
        boolean result = underTest.canProcess(NOT_END_PLACE_COMMAND);
