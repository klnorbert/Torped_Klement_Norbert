 ...
 */
public class DefaultCommandGame implements Command {

    //Final!

    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultCommandGame.class);
     ...
     */
    public DefaultCommandGame(PrintWrapper printWrapper) {
