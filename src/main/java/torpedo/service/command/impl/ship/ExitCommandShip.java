 ...
 */
public class ExitCommandShip implements Command {

    //Final!

    private static final Logger LOGGER = LoggerFactory.getLogger(ExitCommandShip.class);
     ...
     */
    public ExitCommandShip(GameState gameState) {
